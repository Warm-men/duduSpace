    ...
    if (Object.keys(dryInfo).length <= 0) {
      return (
        <Tip
          ...
          style={{ position: 'absolute', top: cx(15), left: cx(22) }}
        ...
        <View style={styles.contentBox}>
          ...
          {autoLockEnable && (
            <Tip
              ...
              style={{ position: 'absolute', bottom: cx(80), left: cx(15) }}
          ...
          <Tip
            ...
            style={{ position: 'absolute', bottom: cx(103), right: cx(14.5) }}
            subTitleStyle={{
              marginLeft: cx(3),
